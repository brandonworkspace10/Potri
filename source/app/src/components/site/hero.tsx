import { BOOK_URL, CallieMark } from "./brand";
...
const SMS_THREAD: { from: "callie" | "lead"; text: string; i: number }[] = [
  {
    from: "callie",
    text: "Hi Maria, it's Callie with Ridgeline Home Buyers. You asked about a cash offer for 412 Alder St. Still a good time for a quick call?",
    i: 0,
  },
    ...
    <section id="top" className="relative overflow-hidden">
      ...
      <div className="mx-auto grid w-full max-w-6xl items-center gap-12 px-5 pb-20 pt-16 md:px-8 md:pb-24 md:pt-20 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="max-w-xl">
          ...
          >
            hey, I'm <span className="text-[#A97B2F]">Callie.</span>
          </h1>
          <p

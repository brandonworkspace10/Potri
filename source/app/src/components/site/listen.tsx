...
import { CallieMark, Container } from "./brand";

const TRANSCRIPT: { who: "callie" | "maria"; text: string }[] = [
  { who: "callie", text: "Hi, is this Maria? This is Callie calling for Ridgeline Home Buyers, about the house on Alder Street." },
  { who: "maria", text: "Oh right, I filled out the form last week." },
  { who: "callie", text: "You did. Are you still thinking about selling, or did I catch you past that?" },
  { who: "maria", text: "No, we still want to sell. The roof needs work and we already moved out." },
  { who: "callie", text: "That's exactly the kind of house we buy, so the roof is no problem. Would Thursday at 10:30 work for a walkthrough offer?" },
              ...
              >
                <span
                  className={`font-mono-call mt-0.5 w-14 shrink-0 text-[11px] font-medium uppercase tracking-wide ${
                    line.who === "callie" ? "text-[#2B5FEB]" : "text-[#A97B2F]"
                  }`}
                >
                  {line.who}
                </span>
